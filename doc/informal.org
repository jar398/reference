...
communicate (send 'messages') and are recipients of messages, channels
such as air or water over which messages are sent, and parts that are
of mutual concern to sender and recipient.
...
I'll need an abstract term to refer to something involved in
communication.  The word _agent_ comes from computer science and is
...
Another approach to the study of communication is _semantics_, which
